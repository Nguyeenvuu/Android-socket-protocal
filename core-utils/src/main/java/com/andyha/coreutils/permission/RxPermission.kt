package com.lucas.coreutils.permission

import android.annotation.SuppressLint
import android.content.Context
import android.content.pm.PackageManager
import androidx.core.content.ContextCompat
import com.lucas.coreextension.subscribeSafely
...
class RxPermission private constructor(private val context: Context) {
    ...
    private fun startPermissionsAsk() {
        val shadowActivity =
            Class.forName("com.lucas.coreui.base.permission.ShadowActivity").kotlin
