package com.lucas.coretesting.sharepreference
...
import com.lucas.coretesting.sharepreference.internal.ContextMock
import com.lucas.coretesting.sharepreference.internal.SPContextWrapperMock
import com.lucas.coretesting.sharepreference.internal.SharedPreferencesFactory
...
class SharePreferenceMocker {
    ...
    fun mockAppSharedPreference(context: Application): AppSharedPreference {
        whenever(context.packageName) doReturn "com.lucas.corearchitecture.app"
